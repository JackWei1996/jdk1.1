/*
 * 官方地址： https://docs.oracle.com/javase/1.5.0/docs/guide/serialization/examples/externsuper/Savesuper.java
 */
...
/**
 * 当使用 Externalizable 接口时，可外部化对象必须实现 writeExternal 方法来保存对象的状态。
 * 它还必须显式地与其超类型协调以保存其状态。
 *
 * 这个简单的示例展示了如何对超类型也可外部化的对象执行此操作。
 *
 *  How to Run:
